...
export default function Page() {
  return (
    <DocPage eyebrow={"Getting started"} title={"Installation"} lede={"This page walks you through adding Ketoy `0.4.0-alpha` to an Android project \u2014 either via the **`ketoy` CLI** (fastest path, recommended for new projects) or by editing Gradle files yourself."}>
      <Content />
    </DocPage>
  );
}
