...
export const metadata = {
  ...
  description:
    'From an empty Android app to a working KBC screen in four steps with Ketoy.',
};
    ...
    <>
      ...
      <section className="page-head">
        <div className="container">
          ...
          <p className="lede">
            From an empty Android app to a working KBC screen in four steps. Author Jetpack Compose screens, compile them to portable KBC bytecode, and ship them inside your APK as a signed <code style={{ fontFamily: 'var(--font-mono)', fontSize: '0.92em' }}>.ktx</code> asset that the Ketoy runtime executes natively.
          </p>
          <div className="hero-actions" style={{ marginTop: 28 }}>
            <a className="btn btn-primary" href="#install">Install Ketoy</a>
