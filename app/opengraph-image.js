...
// convention. Correct dimensions + on-brand OTA/SDUI positioning for every
// share on Google, Slack, X, LinkedIn, etc.
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';
export const alt = 'Ketoy - Kotlin over-the-air (OTA) updates for Android, server-driven UI (SDUI) included.';
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ color: '#b6b5b0', fontSize: 30, marginTop: 26, maxWidth: 900 }}>
            Write Kotlin and Jetpack Compose. Push changes over-the-air in seconds. No Play Store release.
          </div>
        </div>
