...
`dev.ketoy.vm:ketoy-adapters-material3:0.4.16-alpha`.
...
`VerticalDivider` are catalogued as of `0.4.16-alpha`.
...
New in `0.4.16-alpha`, these bring the common Compose layout ergonomics
into KBC.
