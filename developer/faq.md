...
Common questions about Ketoy, what it is, what it isn't, and how to
work with it.
...
`0.3.4-alpha` is **alpha**. The wire format, opcode set, and adapter
...
- **Android only** today. Compose Multiplatform support is on the
  roadmap; KMP-iOS execution isn't.
...
[Custom Capabilities](guides/custom-capability.md):
...
See [Hilt](guides/hilt.md), [Room](guides/room.md),
