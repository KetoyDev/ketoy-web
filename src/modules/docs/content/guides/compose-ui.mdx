...
[Kotlin Language guide](/docs/kotlin-language)).
...
> To add one, see [Custom Adapter](/docs/custom-adapter).
...
`@KetoyViewModel`. See [ViewModel guide](/docs/viewmodel).
