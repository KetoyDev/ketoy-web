...
As of **`0.4.0-alpha`**, Ketoy no longer pins your project to a single Kotlin /
...
1. Inserts `id("dev.ketoy.compiler") version "0.4.0-alpha"` into your
...
plugins {
    ...
    id("dev.ketoy.compiler") version "0.4.0-alpha"   // ← Ketoy plugin
...
dependencies {
    val ketoyBom = platform("dev.ketoy.vm:ketoy-bom:0.4.0-alpha")
