...
// Ribbons — adapted from reactbits.dev/animations/ribbons
// Requires ogl (already installed as peer dependency of Galaxy)
...
const Ribbons = ({
  ...
  // Pass a ref to the element that should receive mouse events.
  // Needed when the Ribbons container itself has pointerEvents:none.
  eventSourceRef = null
}) => {
  ...
  useEffect(() => {
    ...
    function updateMouse(e) {
      ...
      mouse.set(
        ...
        (((y - rect.top) / rect.height) * 2 - 1) * -1,
        0
      );
    }
    const eventEl = eventSourceRef?.current || container;
    ...
    maxAge, pointCount, speedMultiplier, enableFade, enableShaderEffect,
    effectAmplitude, backgroundColor
  ]);
