      ...
      <section id="home" className="ketoy-hero">
        ...
        <div className="hero-content">
          ...
          >
            ...
            <span className="hero-pill-text">Ketoy v0.1.4 is available now</span>
          ...
          <p className="hero-subheadline scroll-item scroll-fade-up delay-200" style={{ animationPlayState: 'running' }}>
            The open source, server-driven UI engine for Jetpack Compose. Write K‑DSL, compile to .ktw wire format, render native UI. No Play Store approvals needed.
          </p>
